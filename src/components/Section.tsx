...
export default function Section({ children }: Props) {
  return (
    <section className="flex h-screen w-full items-center justify-center bg-violet-200/20 backdrop-blur-md">
      <div className="pointer-events-auto relative h-screen min-h-1/3 w-full min-w-1/2 rounded-2xl border bg-violet-200/20 shadow-md sm:w-3/4 sm:px-3 md:max-h-[80vh]">
